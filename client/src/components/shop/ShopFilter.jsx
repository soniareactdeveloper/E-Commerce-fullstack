    ...
    <>
      ...
      <div className="flex flex-wrap items-center justify-between bg-[#FAF7F3] px-6 py-4 border-t border-b border-gray-200 text-sm text-gray-700 font-medium select-none">
        ...
        <div className="hidden sm:block">
          ...
          {Math.min(currentPage * showCount, products.length)} of {products.length} results
        </div>

        {/* Right: Show count and Sort by */}
        <div className="flex items-center gap-6">
          {/* Show */}
          <div className="flex items-center gap-2">
            <label htmlFor="showCount" className="whitespace-nowrap">
              Show
            </label>
            <select
              id="showCount"
